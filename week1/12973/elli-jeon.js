...
=> 잘못 생각했던 점. 
1. 별도 보관 중이었던 것을 다시 합칠 이유가 없었음. 어차피 거기에 두어도 다시 for문 돌리면서 만나는 애랑 같으면 pop시켜서 사라질 것임. 
2. arr도 굳이 빼고 할 필요가 없이 그대로 두고 비교하면 됨. 그대로 뒀으면 for문을 한번만 돌리면 되게 되는 것
3. 맨처음 시작할 때, 1번 element를 미리 넣어두고 시작했으면, 훨씬 편했었음.
*/
